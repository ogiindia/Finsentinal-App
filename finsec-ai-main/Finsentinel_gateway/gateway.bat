...
set "APP_NAME=FinSentinel_AI_Gateway"
set "APP_DISPLAY_NAME=FinSentinel AI-Gateway"
set "COMPANY_NAME=FIS"
set "APP_VERSION=1.0.0"
set "OUTPUT_ROOT=Gateway"
...
@REM   --include-data-files="config/routes.json"
...
python -m nuitka app.py ^
  ...
  --include-data-files="config/routes.json" ^

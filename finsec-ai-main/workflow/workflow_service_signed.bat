...
REM ---------- APP CONFIG ----------
set "APP_NAME=FinSentinel_AI_workflow_service"
set "APP_DISPLAY_NAME=FinSentinel AI-workflow_service"
set "COMPANY_NAME=FIS"
set "APP_VERSION=1.0.0"
set "OUTPUT_ROOT=workflow_service"
...
set "EXE_NAME=workflow_service.exe"

...
REM ---------- APP CONFIG ----------
set "APP_NAME=FinSentinel_AI_graphql_service"
set "APP_DISPLAY_NAME=FinSentinel AI-graphql_service"
set "COMPANY_NAME=FIS"
set "APP_VERSION=1.0.0"
set "OUTPUT_ROOT=graphql_service"
...
set "EXE_NAME=graphql_service.exe"
...
python -m nuitka graphql_service.py ^
  --standalone ^

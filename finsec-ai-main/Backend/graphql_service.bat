...
set "APP_NAME=FinSentinel_AI_graphql"
set "APP_DISPLAY_NAME=FinSentinel AI-graphql Service"
set "COMPANY_NAME=FIS"
set "APP_VERSION=1.0.0"
set "OUTPUT_ROOT=grahpql_service"
...
@REM python -m nuitka graphql_service.py ^
@REM   --standalone ^

...
REM ---------- APP CONFIG ----------
set "APP_NAME=FinSentinel_AI_mule_service"
set "APP_DISPLAY_NAME=FinSentinel AI-mule_service"
set "COMPANY_NAME=FIS"
set "APP_VERSION=1.0.0"
set "OUTPUT_ROOT=mule_service"
...
python -m nuitka mule_service.py ^
  --standalone ^
